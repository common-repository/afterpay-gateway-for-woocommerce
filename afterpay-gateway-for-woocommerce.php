...
if ( ! class_exists( 'Afterpay_Plugin' ) ) {
	class Afterpay_Plugin {
		...
		public static function load_classes() {
			...
			require_once __DIR__ . '/class/Cron/class-afterpay-plugin-cron.php';
			if ( class_exists( 'WC_Payment_Gateway' ) ) {
				require_once __DIR__ . '/class/class-wc-gateway-afterpay.php';
			}
		}
		 ...
		 *
		 * @since   2.1.0
		 * @param   WC_Gateway_Afterpay $gateway Gateway instance.
		...
		public static function add_woocommerce_blocks_support() {
			if ( class_exists( 'Automattic\WooCommerce\Blocks\Payments\Integrations\AbstractPaymentMethodType' ) ) {
				require_once __DIR__ . '/class/class-wc-gateway-afterpay-blocks-support.php';
				add_action(
